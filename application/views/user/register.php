			...
			<div class="row">
				...
				<div class="card col-md-12">
				  	<div class="card-header border-bottom">
	                	<h6 class="m-0 text-left">Register CMS</h6>
	              	</div>
				      ...
				      <form method="POST" action="<?= base_url() ?>user/store">
				        ...
				        <div class="input-group mb-3">
				          <div class="input-group input-group-seamless">
				            ...
				            <input type="text" name="nama_lengkap" class="form-control" placeholder="Nama Lengkap" value=""> </div>
				        </div>
				        <div class="input-group mb-3">
				          <div class="input-group input-group-seamless">
				            <span class="input-group-prepend">
				            ...
				            <input type="number" name="telp" class="form-control" placeholder="Nomor Telephone" value=""> </div>
				        </div>
				        <div class="input-group mb-3">
				          <div class="input-group input-group-seamless">
				            <span class="input-group-prepend">
				        ...
				        <!-- <div class="input-group mb-3">
				          <div class="input-group input-group-seamless">
				            ...
				            <input type="password" class="form-control" placeholder="Re-Password" value=""> 
				            </div>
				        </div> -->
				        <div class="input-group mb-3">
				          	<div class="input-group input-group-seamless">
